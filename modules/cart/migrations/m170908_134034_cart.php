...
namespace app\modules\cart\migrations;
...
use app\modules\cart\models\OrderStatus;
use app\modules\cart\models\OrderProduct;
use app\modules\cart\models\OrderHistory;
use app\modules\cart\models\OrderProductHistroy;
use app\modules\cart\models\Delivery;
use app\modules\cart\models\Payment;
use app\modules\cart\models\DeliveryPayment;
...
{
    public $settingsForm = 'app\modules\cart\models\forms\SettingsForm';
