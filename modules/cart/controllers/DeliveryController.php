...
use Yii;
use app\modules\cart\models\search\DeliverySearch;
use app\modules\cart\models\Delivery;
use panix\engine\controllers\AdminController;
use yii\web\HttpException;

class DeliveryController extends ClientController
{
    ...
    public function actionUpdate($id = false)
    {
        ...
        \app\modules\cart\CartDeliveryAsset::register($this->view);
