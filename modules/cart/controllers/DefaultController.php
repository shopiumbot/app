...
use app\modules\cart\models\forms\OrderCreateForm;
...
class DefaultController extends WebController
{
    ...
    public function actions()
    {
        return [
            'promoCode' => [
                'class' => 'app\modules\cart\widgets\promocode\PromoCodeAction',
            ],
        ];
    }
    ...
    public function actionRenderSmallCart()
    {
        ...
        return \app\modules\cart\widgets\cart\CartWidget::widget(['skin' => Yii::$app->request->post('skin')]);
    }
