...
/**
 * @var \app\modules\cart\models\Order $model
 */
...
<div class="shopping-cart row">
    ...
    <div class="col-md-12 col-sm-12">
        ...
        /* $liqpay = new \app\modules\cart\widgets\payment\liqpay\LiqPay('i61699065543', 'ztgu6RktfUWoSCxEDuoBsOlbm762LQScuQ01c0BI');
        ...
        <div class="table-responsive">
            <table id="cart-table" class="table table-striped">
                ...
                <?php foreach ($model->getOrderedProducts()->getModels() as $product) {
                    /** @var \app\modules\cart\models\OrderProduct $product */
                ...
                <?php if (!$model->promoCode) { ?>
                    ...
                    <td colspan="3">
                        <?php
                        echo Html::beginForm();
                        echo app\modules\cart\widgets\promocode\PromoCodeWidget::widget([
                            'model' => $model,
                        ...
                        /*echo \app\modules\cart\widgets\promocode\PromoCodeInput::widget([
                            'model' => $model,
                            'attribute' => 'promocode_id',
                            'options' => [
