                    ...
                    <li>
                        <div class="message-center chat-scroll chat-users">
                            <a href="javascript:void(0)" class="chat-user message-item" id='chat_user_1' data-user-id='1'>
                                        <span class="user-img">
                                            <img src="<?= $this->context->asset->baseUrl; ?>/images/3.jpg" alt="user" class="rounded-circle">
                    ...
                    <div class="card-body">
                        <div class="chat-meta-user pb-3 border-bottom">
                            <div class="current-chat-user-name">
                                        <span>
                                            <img src="<?= $this->context->asset->baseUrl; ?>/images/1.jpg" alt="dynamic-image" class="rounded-circle" width="45">
                        ...
                        <div class="chat-box scrollable" style="height:calc(100vh - 300px);">
                            ...
                            <ul class="chat-list chat" data-user-id="1">
                                <!--chat Row -->
                                <li class="chat-item">
                                    <div class="chat-img"><img src="<?= $this->context->asset->baseUrl; ?>/images/1.jpg" alt="user"></div>
