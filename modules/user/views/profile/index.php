...
//print_r($model->clientDb);
/*
//echo $model->token;
$hook='https://shopiumbot.com/user/webhook/'.$model->webhook;
$telegram = new \Longman\TelegramBot\Telegram($model->token,'shopiumbot');
$result2 = $telegram->deleteWebhook();
    // Set webhook
$result = $telegram->setWebHook($hook);
//$result = $telegram->setWebHook('https://shopiumbot.com/hook.php');
    if ($result->isOk()) {
        echo $hook;
